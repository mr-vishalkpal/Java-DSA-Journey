...
public class JumpGame_UsingRecursion {
    ...
    static int minJumpsRecur(int i, int arr[]){
        ...
        // traverse through all the points reachable from arr[i] recursively get the minimum number of jumps needed to reach array end from these points 
